...
<td><input type="password" name="npassword" value="" >
</td>
</tr>
...
<td><input type="password" name="cnpassword" value="" >
</td>
</tr>
...
<br>
<input type="submit" name="cpass" value="UPDATE" class="btn btn-success" >
</form></center>
